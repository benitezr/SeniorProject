...
GO
PRINT N'Altering [dbo].[GetTransCategoriesForLine]...';


GO
ALTER procedure [dbo].[GetTransCategoriesForLine]
(
	@deptid as int = null,
...
ALTER TABLE [dbo].[Transactions] WITH CHECK CHECK CONSTRAINT [FK_Staff];

ALTER TABLE [dbo].[Transactions] WITH CHECK CHECK CONSTRAINT [FK_Dept];
